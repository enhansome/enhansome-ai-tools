...
* [MemFree](https://github.com/memfreeme/memfree) ⭐ 1,505 | 🐛 18 | 🌐 TypeScript | 📅 2026-07-06 - Open Source Hybrid AI Search Engine, Instantly Get Accurate Answers from the Internet, Bookmarks, Notes, and Docs
...
* [privateGPT](https://github.com/imartinez/privateGPT) ⭐ 57,491 | 🐛 6 | 🌐 Python | 📅 2026-08-28 - Ask questions to your documents without an internet connection, using the power of LLMs.
* [quivr](https://github.com/StanGirard/quivr) ⭐ 39,436 | 🐛 33 | 🌐 Python | 📅 2025-07-09 - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings.
...
* [fabric](https://github.com/danielmiessler/fabric/) ⭐ 43,584 | 🐛 66 | 🌐 Go | 📅 2026-08-29 - Apply AI to everyday challenges in the comfort of your terminal. Help’s to get better results with tried and tested library of prompt pattern’s.
...
* [Langfuse](https://langfuse.com/) - Open-source LLM engineering platform that helps teams collaboratively debug, analyze, and iterate on their LLM applications. [#opensource](https://github.com/langfuse/langfuse) ⭐ 33,938 | 🐛 863 | 🌐 TypeScript | 📅 2026-08-30
...
* [VoltAgent](https://github.com/voltagent/voltagent) ⭐ 10,464 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-27 - A TypeScript framework for building and running AI agents with tools, memory, and visibility.
* [Agenta](https://agenta.ai/) - Open-source LLMOps platform for prompt management, LLM evaluation, and observability. Build, evaluate, and monitor production-grade LLM applications. [#opensource](https://github.com/agenta-ai/agenta) ⭐ 4,647 | 🐛 312 | 🌐 TypeScript | 📅 2026-08-30
* [ToolHive](https://github.com/stacklok/toolhive) ⭐ 2,056 | 🐛 380 | 🌐 Go | 📅 2026-08-30 – Find the right MCP server for your task and deploy with one click.
* [Notte](https://github.com/nottelabs/notte) ⭐ 1,999 | 🐛 10 | 🌐 Python | 📅 2026-08-30 - Notte is the fastest, most reliable Browser Using Agents framework
...
* [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,103 | 🐛 133 | 🌐 Python | 📅 2026-01-21 - The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo
* [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,769 | 🐛 62 | 🌐 Python | 📅 2026-08-30 - AI-powered tool for automated PR analysis, feedback, suggestions, and more.
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,488 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-30 - An alternative to Supabase for AI Code editors and Vibe Coding tools
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,016 | 🐛 32 | 🌐 Go | 📅 2026-08-30 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
...
*For a more complete list of AI Image tools visit: [Best Image AI Tools](https://github.com/mahseema/awesome-ai-tools/blob/main/IMAGE.md) ⭐ 6,092 | 🐛 1,262 | 📅 2025-12-31 or [Awesome AI Image](https://github.com/xaramore/awesome-ai-image)*
...
\*You can also find  more comprehensive list on *[Marketing List](https://github.com/mahseema/awesome-ai-tools/blob/main/marketing.md) ⭐ 6,092 | 🐛 1,262 | 📅 2025-12-31*
...
* [Petals](https://github.com/bigscience-workshop/petals) ⭐ 10,530 | 🐛 113 | 🌐 Python | 📅 2024-09-07 - BitTorrent style platform for running AI models in a distributed way.
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,913 | 🐛 278 | 🌐 MDX | 📅 2026-03-11 - Guide and resources for prompt engineering.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,625 | 🐛 296 | 🌐 Jupyter Notebook | 📅 2026-08-30 - Examples and guides for using the OpenAI API.
...
* [Awesome AI Coding Tools](https://github.com/ai-for-developers/awesome-ai-coding-tools) ⭐ 2,043 | 🐛 345 | 📅 2026-04-25 - Curated list of AI-powered developer tools.
...
* [Best of AI](https://github.com/best-of-ai/best-of-ai) ⭐ 702 | 🐛 100 | 🌐 HTML | 📅 2026-08-27 - Like Michelin Guide for AI
* [Awesome Marketing](https://github.com/marketingtoolslist/awesome-marketing) ⭐ 444 | 🐛 122 | 📅 2026-07-27
