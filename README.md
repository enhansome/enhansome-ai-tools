...
* [privateGPT](https://github.com/imartinez/privateGPT) ⭐ 57,446 | 🐛 7 | 🌐 Python | 📅 2026-08-17 - Ask questions to your documents without an internet connection, using the power of LLMs.
...
* [fabric](https://github.com/danielmiessler/fabric/) ⭐ 43,468 | 🐛 63 | 🌐 Go | 📅 2026-08-09 - Apply AI to everyday challenges in the comfort of your terminal. Help’s to get better results with tried and tested library of prompt pattern’s.
...
* [gpt4all](https://github.com/nomic-ai/gpt4all) ⭐ 77,405 | 🐛 773 | 🌐 C++ | 📅 2025-05-27 - A chatbot trained on a massive collection of clean assistant data including code, stories, and dialogue.
* [Langfuse](https://langfuse.com/) - Open-source LLM engineering platform that helps teams collaboratively debug, analyze, and iterate on their LLM applications. [#opensource](https://github.com/langfuse/langfuse) ⭐ 33,262 | 🐛 784 | 🌐 TypeScript | 📅 2026-08-17
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,590 | 🐛 60 | 🌐 Go | 📅 2025-10-03 - Open source, terminal-based AI programming engine for complex tasks.
* [VoltAgent](https://github.com/voltagent/voltagent) ⭐ 10,370 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-10 - A TypeScript framework for building and running AI agents with tools, memory, and visibility.
* [Agenta](https://agenta.ai/) - Open-source LLMOps platform for prompt management, LLM evaluation, and observability. Build, evaluate, and monitor production-grade LLM applications. [#opensource](https://github.com/agenta-ai/agenta) ⭐ 4,487 | 🐛 350 | 🌐 TypeScript | 📅 2026-08-17
* [ToolHive](https://github.com/stacklok/toolhive) ⭐ 2,022 | 🐛 384 | 🌐 Go | 📅 2026-08-17 – Find the right MCP server for your task and deploy with one click.
* [Notte](https://github.com/nottelabs/notte) ⭐ 1,993 | 🐛 15 | 🌐 Python | 📅 2026-08-17 - Notte is the fastest, most reliable Browser Using Agents framework
...
* [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 69,865 | 🐛 129 | 🌐 Python | 📅 2026-01-21 - The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo
* [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,585 | 🐛 149 | 🌐 Python | 📅 2026-08-16 - AI-powered tool for automated PR analysis, feedback, suggestions, and more.
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,452 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-17 - An alternative to Supabase for AI Code editors and Vibe Coding tools
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,008 | 🐛 23 | 🌐 Go | 📅 2026-08-17 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
...
*For a more complete list of AI Image tools visit: [Best Image AI Tools](https://github.com/mahseema/awesome-ai-tools/blob/main/IMAGE.md) ⭐ 5,984 | 🐛 1,227 | 📅 2025-12-31 or [Awesome AI Image](https://github.com/xaramore/awesome-ai-image)*
...
\*You can also find  more comprehensive list on *[Marketing List](https://github.com/mahseema/awesome-ai-tools/blob/main/marketing.md) ⭐ 5,984 | 🐛 1,227 | 📅 2025-12-31*
...
* [Petals](https://github.com/bigscience-workshop/petals) ⭐ 10,497 | 🐛 113 | 🌐 Python | 📅 2024-09-07 - BitTorrent style platform for running AI models in a distributed way.
* [Harbor](https://github.com/av/harbor) ⭐ 3,172 | 🐛 64 | 🌐 Python | 📅 2026-08-16 - run LLM backends, APIs, frontends, and services with one command
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,528 | 🐛 279 | 🌐 MDX | 📅 2026-03-11 - Guide and resources for prompt engineering.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,294 | 🐛 245 | 🌐 Jupyter Notebook | 📅 2026-08-17 - Examples and guides for using the OpenAI API.
...
* [Awesome AI Coding Tools](https://github.com/ai-for-developers/awesome-ai-coding-tools) ⭐ 2,009 | 🐛 322 | 📅 2026-04-25 - Curated list of AI-powered developer tools.
...
* [Awesome Vibe Coding](http://github.com/dariubs/awesome-vibe-coding) ⭐ 815 | 🐛 75 | 🌐 HTML | 📅 2026-08-13 - A hand-picked collection of tools and resources for Vibe Coding.
* [Best of AI](https://github.com/best-of-ai/best-of-ai) ⭐ 697 | 🐛 96 | 🌐 HTML | 📅 2026-08-12 - Like Michelin Guide for AI
* [Awesome Marketing](https://github.com/marketingtoolslist/awesome-marketing) ⭐ 436 | 🐛 120 | 📅 2026-07-27
