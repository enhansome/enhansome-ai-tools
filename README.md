...
* [privateGPT](https://github.com/imartinez/privateGPT) ⭐ 57,501 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - Ask questions to your documents without an internet connection, using the power of LLMs.
* [quivr](https://github.com/StanGirard/quivr) ⭐ 39,511 | 🐛 38 | 🌐 Python | 📅 2026-08-31 - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings.
...
* [fabric](https://github.com/danielmiessler/fabric/) ⭐ 43,905 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - Apply AI to everyday challenges in the comfort of your terminal. Help’s to get better results with tried and tested library of prompt pattern’s.
...
* [Langfuse](https://langfuse.com/) - Open-source LLM engineering platform that helps teams collaboratively debug, analyze, and iterate on their LLM applications. [#opensource](https://github.com/langfuse/langfuse) ⭐ 34,513 | 🐛 923 | 🌐 TypeScript | 📅 2026-09-12
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,632 | 🐛 63 | 🌐 Go | 📅 2025-10-03 - Open source, terminal-based AI programming engine for complex tasks.
* [VoltAgent](https://github.com/voltagent/voltagent) ⭐ 10,602 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-27 - A TypeScript framework for building and running AI agents with tools, memory, and visibility.
* [Agenta](https://agenta.ai/) - Open-source LLMOps platform for prompt management, LLM evaluation, and observability. Build, evaluate, and monitor production-grade LLM applications. [#opensource](https://github.com/agenta-ai/agenta) ⭐ 4,748 | 🐛 306 | 🌐 TypeScript | 📅 2026-09-12
* [ToolHive](https://github.com/stacklok/toolhive) ⭐ 2,162 | 🐛 370 | 🌐 Go | 📅 2026-09-11 – Find the right MCP server for your task and deploy with one click.
* [Notte](https://github.com/nottelabs/notte) ⭐ 2,002 | 🐛 15 | 🌐 Python | 📅 2026-09-12 - Notte is the fastest, most reliable Browser Using Agents framework
...
* [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,338 | 🐛 135 | 🌐 Python | 📅 2026-01-21 - The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo
* [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,958 | 🐛 106 | 🌐 Python | 📅 2026-09-11 - AI-powered tool for automated PR analysis, feedback, suggestions, and more.
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,521 | 🐛 107 | 🌐 TypeScript | 📅 2026-09-12 - An alternative to Supabase for AI Code editors and Vibe Coding tools
...
*For a more complete list of AI Image tools visit: [Best Image AI Tools](https://github.com/mahseema/awesome-ai-tools/blob/main/IMAGE.md) ⭐ 6,182 | 🐛 1,324 | 📅 2025-12-31 or [Awesome AI Image](https://github.com/xaramore/awesome-ai-image)*
...
* [TTS WebUI](https://github.com/rsxdalv/tts-generation-webui) ⭐ 3,260 | 🐛 131 | 🌐 TypeScript | 📅 2026-09-07 - Open Source generative AI App for voice and music, supporting 15+ TTS models.
...
\*You can also find  more comprehensive list on *[Marketing List](https://github.com/mahseema/awesome-ai-tools/blob/main/marketing.md) ⭐ 6,182 | 🐛 1,324 | 📅 2025-12-31*
...
* [Petals](https://github.com/bigscience-workshop/petals) ⭐ 10,559 | 🐛 114 | 🌐 Python | 📅 2024-09-07 - BitTorrent style platform for running AI models in a distributed way.
* [Harbor](https://github.com/av/harbor) ⭐ 3,216 | 🐛 66 | 🌐 Python | 📅 2026-09-07 - run LLM backends, APIs, frontends, and services with one command
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,246 | 🐛 281 | 🌐 MDX | 📅 2026-03-11 - Guide and resources for prompt engineering.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,946 | 🐛 289 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Examples and guides for using the OpenAI API.
...
* [Awesome AI Coding Tools](https://github.com/ai-for-developers/awesome-ai-coding-tools) ⭐ 2,069 | 🐛 369 | 📅 2026-04-25 - Curated list of AI-powered developer tools.
* [Awesome Workflow Automation](https://github.com/dariubs/awesome-workflow-automation) ⭐ 1,220 | 🐛 69 | 📅 2026-04-28 - Curated List of Workflow Automation Apps And Tools
...
* [Best of AI](https://github.com/best-of-ai/best-of-ai) ⭐ 714 | 🐛 112 | 🌐 HTML | 📅 2026-09-12 - Like Michelin Guide for AI
