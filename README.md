...
* [privateGPT](https://github.com/imartinez/privateGPT) ⭐ 57,502 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - Ask questions to your documents without an internet connection, using the power of LLMs.
* [quivr](https://github.com/StanGirard/quivr) ⭐ 39,509 | 🐛 38 | 🌐 Python | 📅 2026-08-31 - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings.
...
* [fabric](https://github.com/danielmiessler/fabric/) ⭐ 43,892 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - Apply AI to everyday challenges in the comfort of your terminal. Help’s to get better results with tried and tested library of prompt pattern’s.
...
* [Langfuse](https://langfuse.com/) - Open-source LLM engineering platform that helps teams collaboratively debug, analyze, and iterate on their LLM applications. [#opensource](https://github.com/langfuse/langfuse) ⭐ 34,486 | 🐛 919 | 🌐 TypeScript | 📅 2026-09-11
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,631 | 🐛 63 | 🌐 Go | 📅 2025-10-03 - Open source, terminal-based AI programming engine for complex tasks.
* [VoltAgent](https://github.com/voltagent/voltagent) ⭐ 10,597 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-27 - A TypeScript framework for building and running AI agents with tools, memory, and visibility.
* [Agenta](https://agenta.ai/) - Open-source LLMOps platform for prompt management, LLM evaluation, and observability. Build, evaluate, and monitor production-grade LLM applications. [#opensource](https://github.com/agenta-ai/agenta) ⭐ 4,745 | 🐛 299 | 🌐 TypeScript | 📅 2026-09-11
* [ToolHive](https://github.com/stacklok/toolhive) ⭐ 2,159 | 🐛 370 | 🌐 Go | 📅 2026-09-11 – Find the right MCP server for your task and deploy with one click.
* [Notte](https://github.com/nottelabs/notte) ⭐ 2,001 | 🐛 12 | 🌐 Python | 📅 2026-09-11 - Notte is the fastest, most reliable Browser Using Agents framework
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,049 | 🐛 15 | 🌐 Python | 📅 2025-11-27 - Open-source CLI security scanner for agentic workflows.
...
* [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 70,325 | 🐛 135 | 🌐 Python | 📅 2026-01-21 - The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo
* [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,953 | 🐛 87 | 🌐 Python | 📅 2026-09-11 - AI-powered tool for automated PR analysis, feedback, suggestions, and more.
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,520 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-11 - An alternative to Supabase for AI Code editors and Vibe Coding tools
* [WhoDB](https://github.com/clidey/whodb) ⭐ 5,023 | 🐛 39 | 🌐 Go | 📅 2026-09-11 - SQL/NoSQL/Graph/Cache/Object data explorer with AI-powered chat + other useful features
...
* [Gito](https://github.com/Nayjest/Gito) ⭐ 430 | 🐛 59 | 🌐 Python | 📅 2026-09-05 - AI code reviewer for GitHub Actions or local use, compatible with any LLM and integrated with Jira/Linear.
...
*For a more complete list of AI Image tools visit: [Best Image AI Tools](https://github.com/mahseema/awesome-ai-tools/blob/main/IMAGE.md) ⭐ 6,176 | 🐛 1,318 | 📅 2025-12-31 or [Awesome AI Image](https://github.com/xaramore/awesome-ai-image)*
...
* [TTS WebUI](https://github.com/rsxdalv/tts-generation-webui) ⭐ 3,259 | 🐛 131 | 🌐 TypeScript | 📅 2026-09-07 - Open Source generative AI App for voice and music, supporting 15+ TTS models.
...
\*You can also find  more comprehensive list on *[Marketing List](https://github.com/mahseema/awesome-ai-tools/blob/main/marketing.md) ⭐ 6,176 | 🐛 1,318 | 📅 2025-12-31*
...
* [Petals](https://github.com/bigscience-workshop/petals) ⭐ 10,556 | 🐛 114 | 🌐 Python | 📅 2024-09-07 - BitTorrent style platform for running AI models in a distributed way.
* [Harbor](https://github.com/av/harbor) ⭐ 3,215 | 🐛 66 | 🌐 Python | 📅 2026-09-07 - run LLM backends, APIs, frontends, and services with one command
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,211 | 🐛 281 | 🌐 MDX | 📅 2026-03-11 - Guide and resources for prompt engineering.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,922 | 🐛 288 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Examples and guides for using the OpenAI API.
...
* [Awesome AI Coding Tools](https://github.com/ai-for-developers/awesome-ai-coding-tools) ⭐ 2,065 | 🐛 363 | 📅 2026-04-25 - Curated list of AI-powered developer tools.
* [Awesome Workflow Automation](https://github.com/dariubs/awesome-workflow-automation) ⭐ 1,218 | 🐛 69 | 📅 2026-04-28 - Curated List of Workflow Automation Apps And Tools
* [Top AI Directories](https://github.com/best-of-ai/ai-directories) ⭐ 870 | 🐛 135 | 📅 2026-05-15 - An awesome list of best top AI directories to submit your ai tools
* [Awesome Vibe Coding](http://github.com/dariubs/awesome-vibe-coding) ⭐ 835 | 🐛 92 | 🌐 HTML | 📅 2026-08-13 - A hand-picked collection of tools and resources for Vibe Coding.
* [Best of AI](https://github.com/best-of-ai/best-of-ai) ⭐ 712 | 🐛 110 | 🌐 HTML | 📅 2026-09-07 - Like Michelin Guide for AI
* [Awesome Marketing](https://github.com/marketingtoolslist/awesome-marketing) ⭐ 453 | 🐛 129 | 📅 2026-07-27
