...
* [privateGPT](https://github.com/imartinez/privateGPT) ⭐ 57,458 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - Ask questions to your documents without an internet connection, using the power of LLMs.
...
* [Chatbot UI](https://www.chatbotui.com/) - An open source ChatGPT UI. [Source code](https://github.com/mckaywrigley/chatbot-ui) ⭐ 33,339 | 🐛 240 | 🌐 TypeScript | 📅 2024-08-03.
...
* [fabric](https://github.com/danielmiessler/fabric/) ⭐ 43,509 | 🐛 64 | 🌐 Go | 📅 2026-08-09 - Apply AI to everyday challenges in the comfort of your terminal. Help’s to get better results with tried and tested library of prompt pattern’s.
...
* [Langfuse](https://langfuse.com/) - Open-source LLM engineering platform that helps teams collaboratively debug, analyze, and iterate on their LLM applications. [#opensource](https://github.com/langfuse/langfuse) ⭐ 33,583 | 🐛 818 | 🌐 TypeScript | 📅 2026-08-23
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,593 | 🐛 61 | 🌐 Go | 📅 2025-10-03 - Open source, terminal-based AI programming engine for complex tasks.
* [VoltAgent](https://github.com/voltagent/voltagent) ⭐ 10,404 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-10 - A TypeScript framework for building and running AI agents with tools, memory, and visibility.
* [Agenta](https://agenta.ai/) - Open-source LLMOps platform for prompt management, LLM evaluation, and observability. Build, evaluate, and monitor production-grade LLM applications. [#opensource](https://github.com/agenta-ai/agenta) ⭐ 4,521 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-23
* [ToolHive](https://github.com/stacklok/toolhive) ⭐ 2,035 | 🐛 381 | 🌐 Go | 📅 2026-08-23 – Find the right MCP server for your task and deploy with one click.
...
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,041 | 🐛 15 | 🌐 Python | 📅 2025-11-27 - Open-source CLI security scanner for agentic workflows.
...
* [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 69,969 | 🐛 133 | 🌐 Python | 📅 2026-01-21 - The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo
* [PR-Agent](https://github.com/Codium-ai/pr-agent) ⭐ 12,672 | 🐛 126 | 🌐 Python | 📅 2026-08-23 - AI-powered tool for automated PR analysis, feedback, suggestions, and more.
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,473 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-23 - An alternative to Supabase for AI Code editors and Vibe Coding tools
...
*For a more complete list of AI Image tools visit: [Best Image AI Tools](https://github.com/mahseema/awesome-ai-tools/blob/main/IMAGE.md) ⭐ 6,027 | 🐛 1,244 | 📅 2025-12-31 or [Awesome AI Image](https://github.com/xaramore/awesome-ai-image)*
...
\*You can also find  more comprehensive list on *[Marketing List](https://github.com/mahseema/awesome-ai-tools/blob/main/marketing.md) ⭐ 6,027 | 🐛 1,244 | 📅 2025-12-31*
...
* [Harbor](https://github.com/av/harbor) ⭐ 3,186 | 🐛 64 | 🌐 Python | 📅 2026-08-16 - run LLM backends, APIs, frontends, and services with one command
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,728 | 🐛 278 | 🌐 MDX | 📅 2026-03-11 - Guide and resources for prompt engineering.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,501 | 🐛 296 | 🌐 Jupyter Notebook | 📅 2026-08-23 - Examples and guides for using the OpenAI API.
...
* [Awesome AI Coding Tools](https://github.com/ai-for-developers/awesome-ai-coding-tools) ⭐ 2,026 | 🐛 332 | 📅 2026-04-25 - Curated list of AI-powered developer tools.
* [Awesome Workflow Automation](https://github.com/dariubs/awesome-workflow-automation) ⭐ 1,176 | 🐛 69 | 📅 2026-04-28 - Curated List of Workflow Automation Apps And Tools
* [Top AI Directories](https://github.com/best-of-ai/ai-directories) ⭐ 866 | 🐛 121 | 📅 2026-05-15 - An awesome list of best top AI directories to submit your ai tools
* [Awesome Vibe Coding](http://github.com/dariubs/awesome-vibe-coding) ⭐ 820 | 🐛 82 | 🌐 HTML | 📅 2026-08-13 - A hand-picked collection of tools and resources for Vibe Coding.
* [Best of AI](https://github.com/best-of-ai/best-of-ai) ⭐ 700 | 🐛 96 | 🌐 HTML | 📅 2026-08-17 - Like Michelin Guide for AI
* [Awesome Marketing](https://github.com/marketingtoolslist/awesome-marketing) ⭐ 439 | 🐛 123 | 📅 2026-07-27
